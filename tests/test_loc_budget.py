...
TOTAL_LIMIT = 24150  # Wave 60 (2026-05-15): +50 for Slice 29 — broadened Phase G's readiness-contract refresh from item-13-only to a full multi-item pass (`_refresh_readiness_contract_items`). Rebuilds items 1 (product_tiers), 7 (deterministic_manuscript_compiler), 9 (journal_surface_gate), 12 (target_journal_finalizer), and 13 (accountability) from current sidecar state. Reviewer feedback identified these as the items that go stale because their Stage-5c values predate Phase G's surface re-eval + Slice 21's target_journal_pack writer. Universal — no per-topic logic. Wave 59 (2026-05-15): +50 for Slice 28 Phase H topic-slug normalisation. Wave 58 (2026-05-15): +50 for Slice 19 Phase G surface re-evaluation. Wave 57 (2026-05-14): +50 for Slice 18 prose polish + accountability split + initial Phase G sidecar reconciliation.
