...
Measures `composite_score` (and 4 sub-metrics) for every gold topic so you can
...
| `quantitative_fidelity` | 0.40 | Numeric values in draft match gold |
| `direction_agreement` | 0.30 | Conclusion direction vs gold |
| `limitation_overlap` | 0.20 | Limitation coverage vs gold |
