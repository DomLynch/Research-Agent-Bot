...
def render_methods(c: RunModeContract) -> str:
    ...
    return (
        ...
        f"high-confidence bound claims used by the writer; the load-bearing "
        f"principle is **LLM proposes, code disposes** — no claim, citation, "
        f"evidence tier, or thesis is author-LLM-invented.\n\n"
        f"### LLM roles\n\n"
