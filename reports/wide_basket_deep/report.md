...
| --- | --- | --- | ---: | ---: | ---: | --- | --- | --- |
| `acarbose` | run_now | ready | 3 | 5 | 0 | pass | not-run | maturity , receipts  |
| `aerobic_exercise` | corpus_tune_first | needs corpus tuning | 6 | 5 | 0 | corpus-thin | not-run | maturity , receipts  |
| `aspirin` | corpus_tune_first | needs corpus tuning | 8 | 10 | 4 | corpus-thin | not-run | maturity , receipts  |
| `berberine` | run_now | ready | 3 | 5 | 0 | pass | not-run | maturity , receipts  |
| `caloric_restriction` | rich_monitor | rich baseline present | 5 | 5 | 0 | pass | pass | maturity 0, receipts 36 |
| `collagen_peptides` | run_now | ready | 5 | 5 | 0 | not-run | not-run | maturity , receipts  |
| `creatine` | rich_monitor | rich baseline present | 4 | 5 | 0 | grok | pass | maturity 0, receipts 0 |
| `everolimus` | run_now | ready | 7 | 6 | 1 | not-run | not-run | maturity , receipts  |
| `glp1` | l6_rerun | needs L6 confirmation | 16 | 7 | 6 | corpus-thin | pass | maturity 0, receipts 0 |
| `intermittent_fasting` | run_now | ready | 6 | 5 | 0 | pass | not-run | maturity , receipts  |
| `metformin` | l6_rerun | needs L6 confirmation | 5 | 6 | 4 | pass | pass | maturity 1, receipts 28 |
| `nad_precursors` | corpus_tune_first | needs corpus tuning | 13 | 7 | 3 | corpus-thin | not-run | maturity , receipts  |
| `omega3` | rich_monitor | rich baseline present | 7 | 5 | 0 | js | pass | maturity 0, receipts 29 |
| `protein_nutrition` | run_now | ready | 6 | 5 | 0 | pass | not-run | maturity , receipts  |
| `rapamycin` | l6_rerun | needs L6 confirmation | 5 | 6 | 4 | grok | pass | maturity 0, receipts 0 |
| `resistance_training` | run_now | ready | 5 | 5 | 0 | pass | not-run | maturity , receipts  |
| `sauna_heat_therapy` | run_now | ready | 5 | 5 | 0 | not-run | not-run | maturity , receipts  |
| `senolytics` | corpus_tune_first | needs corpus tuning | 11 | 7 | 3 | grok | not-run | maturity , receipts  |
| `sleep_health` | run_now | ready | 7 | 5 | 0 | not-run | not-run | maturity , receipts  |
| `spermidine` | run_now | ready | 3 | 5 | 0 | not-run | not-run | maturity , receipts  |
| `statins` | rich_monitor | rich baseline present | 11 | 13 | 4 | grok | pass | maturity 0, receipts 31 |
| `taurine` | run_now | ready | 3 | 5 | 0 | not-run | not-run | maturity , receipts  |
| `urolithin_a` | run_now | ready | 4 | 5 | 0 | not-run | not-run | maturity , receipts  |
| `vitamin_d` | corpus_tune_first | needs corpus tuning | 5 | 5 | 0 | grok | not-run | maturity , receipts  |
| `zone2_training` | run_now | ready | 5 | 5 | 0 | pass | not-run | maturity , receipts  |
