...
## Status — 2026-04-28 — Day 4-fix shipped (P1 deterministic writer — no LLM at write time + P2 real-pipeline planted-failure E2E + specificity proof); Day 5 cleared
...
**Tests:** 559/559 passing in 0.45s. ruff clean. git diff --check clean.
**Runtime LOC (cloc-style, the canonical count enforced by `tests/test_loc_budget.py`):** 4,915 / **5,500** ceiling (10.6% headroom; improved by 178 cloc when Day 4-fix P1 removed the LLM call from writer.py).
