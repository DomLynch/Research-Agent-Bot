...
_PROMPT += " Writer receipt_ids identify the complete cited receipts in this packet. Within author_context, review_reference is a path of keys/indexes from the author_context root to an identical record supplied elsewhere there; resolve it to the complete record. References are transport deduplication, never absent evidence."
