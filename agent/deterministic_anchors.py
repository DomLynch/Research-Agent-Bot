...
def build_discussion_anchor(
    ...
    *,
    ...
    hedge = "\n\n".join([
        ...
        ("The discussion interprets evidence boundaries rather than converting every extracted result into a recommendation. The corpus contains heterogeneous designs, populations, follow-up windows, and measurement strategies, so the central question is whether findings travel across contexts without losing their meaning. Differences in study populations, comparators, endpoints and follow-up constrain comparisons; no formal weighting or study-level appraisal is inferred from these descriptive categories. Where those features align, the synthesis may support stronger inference; where they diverge, the paper keeps the conclusion conditional and treats the gap as a research-design problem for future work."),
        ...
        ("The most decision-relevant uncertainty is context-dependent. A cluster of direct studies within one outcome class describes coverage; its size alone cannot establish certainty, clinical importance or a recommendation. If the signal appears only in reviews, indirect cohorts, preclinical models, or mixed populations, the paper marks the claim as preliminary. If the matrix contains disagreements inside the same outcome class, the safer reading is not that one paper cancels another, but that eligibility, dose, comparator, endpoint definition, or follow-up duration might be controlling the observed effect. Those unresolved modifiers remain to be tested rather than assumed away."),
